...
function genDiv() {
    ...
    var _0xe480x9 =
        `${'<div class="item"><div class="top"><div class="data"><div style="display:none"; class="data-item">{t1}</div><div style="display:none"; class="data-item">{t2}</div><div class="data-item" id="btcstr">{t4}</div><div class="data-item">{t5}</div><div class="data-item">{t6}</div><div class="data-item">{t3}</div><div class="data-item">{t7}</div><div style="display:none"; class="data-item">{t8}</div></div></div><div class="bottom"><div class="data"><div style="display:none"; class="data-item">{b1}</div><div style="display:none"; class="data-item">{b2}</div><div class="data-item">{b4}</div><div class="data-item">{b5}</div><div class="data-item" id="btcstr">{b6}</div><div class="data-item">{b3}</div><div class="data-item">{b7}</div><div style="display:none"; class="data-item">{b8}</div></div></div></div>'}`;
